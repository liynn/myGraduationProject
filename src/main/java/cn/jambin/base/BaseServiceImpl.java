...
import cn.jambin.util.SpringContextUtil;
...
public abstract class BaseServiceImpl<Mapper, Record, Example> implements BaseService<Record, Example> {
	...
	public List<Record> selectByExampleForOffsetPage(Example example, Integer offset, Integer limit) {
		try {
			Method selectByExample = mapper
					.getClass()
					.getDeclaredMethod("selectByExample",
							example.getClass());
	...
	@Override
	public int lockByPrimaryKeys(String ids,Class entity_class, String setId_Method){
		return  lockByPrimaryKeys(ids, entity_class, setId_Method,true, true);
	}

	@Override
	public int lockByPrimaryKeys(String ids,Class entity_class, String setId_Method, boolean isIdInt, boolean isStateByte) {
		try {
			if (StringUtils.isBlank(ids)) {
				return 0;
			}
			...
			for (String idStr : idArray) {
				...
				Record record = (Record)entity_class.newInstance();
				Number id ;
				Number state ;
				...
				Method setId = record.getClass().getDeclaredMethod(setId_Method, id.getClass());
				Method setState = record.getClass().getDeclaredMethod("setState", state.getClass());
				setId.invoke(record, id);
				setState.invoke(record, state);
				Method updateByPrimaryKey = mapper.getClass().getDeclaredMethod("updateByPrimaryKeySelective", record.getClass());
				Object result = updateByPrimaryKey.invoke(mapper, record);
				count += Integer.parseInt(String.valueOf(result));
			}
			return count;
